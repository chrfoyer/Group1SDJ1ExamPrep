public class ZoomLesson extends OnlineLesson
{
  ...
  public ZoomLesson(String topic, Date date, Time start, Time end,
      Resource[] res, boolean camera, String link, boolean breakoutRooms)
  {
  ...
  public boolean equals(Object obj)
  {
    ...
    return super.equals(other) && getLink().equals(other.getLink())
        && usesBreakoutRooms() == other.usesBreakoutRooms();
  }
